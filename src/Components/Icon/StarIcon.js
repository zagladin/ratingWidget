...
const StarIcon = ({width, height, fill, halfFilled, offset, ...rest}) => {

  return (
      <svg
          data-qa="icon"
          data-role="icon-rating"
          width={width}
          height={height}
          ...
          {...rest}
      >
        <linearGradient id="gradientColor" x1="0" x2="1" y1="0" y2="0">
          <stop offset={offset} stopColor="#EC0909"/>
          <stop offset={offset} stopColor="#CBC8C8"/>
        </linearGradient>
        ...
        <path
            ...
            fill={!halfFilled ? fill : 'url(#gradientColor)'}
        />
